...
public class TestClass1 {
    ...
    public static void main(String[] args) {
        ...
        Collections.sort(ls,EmployeeSort.comparator);


        /************* Tree Set Check ***********/
        TreeSet<GenericClass> tset = new TreeSet<GenericClass>();
        GenericClass e = new GenericClass();
        GenericClass e1 = new GenericClass();

        // at the first line when we are adding we will get classcast exception
        //Exception in thread "main" java.lang.ClassCastException: com.abhi.java.core.GenericClass cannot be cast to java.lang.Comparable
        tset.add(e);
        tset.add(e1);
